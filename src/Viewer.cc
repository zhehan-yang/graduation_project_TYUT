    ...
    mbFinishRequested(false), mbFinished(true), mbStopped(true), mbStopRequested(false)
{
	...
	//可视化参数
    mViewpointX = fSettings["Viewer.ViewpointX"];	//这个用在pangolin的ModelViewAt里头
    mViewpointY = fSettings["Viewer.ViewpointY"];
    mViewpointZ = fSettings["Viewer.ViewpointZ"];
    mViewpointF = fSettings["Viewer.ViewpointF"];	//这个是投影矩阵的参数
}
...
bool Viewer::Stop()
{
    ...
    {
        mbStopped = true;
        mbStopRequested = false;	//已经收到了停止的请求
        return true;
    }
