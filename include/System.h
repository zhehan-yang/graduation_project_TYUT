...
public:
    ...
    // Initialize the SLAM system. It launches the Local Mapping, Loop Closing and Viewer threads. 构造函数，需要输入词包路径、YAML配置文件、设置传感器类型,最后一个是是否启用线程
	...
	//他这里没有写TrackStereo和TrackMonocular，只写了一种情况，，这个可以补充
...
private:
    ...
    Vocabulary* mpVocabulary;		//命名有一点点不同
